...
class HeadsetsScreen extends StatefulWidget {
  const HeadsetsScreen({Key? key}) : super(key: key);

  @override
  State<HeadsetsScreen> createState() => _HeadsetsScreenState();
}
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => DetailsScreen(
                                          controllers: headsets, index: index)));
                            },
                            child: Container(
