...
class Ps4Screen extends StatefulWidget {
  const Ps4Screen({super.key});

  @override
  State<Ps4Screen> createState() => _Ps4ScreenState();
}

class _Ps4ScreenState extends State<Ps4Screen> {
  int currentIndex = 0;
  @override
  ...
  GestureDetector productsItems(int index) {
    ...
    final controllers = productList[index];
